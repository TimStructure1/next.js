...
///
/// Use [`impl_encode_for_turbo_bincode_encode`] to automatically implement the `Encode` trait from
/// this one.
...
/// should panic if any other encoder is used.
///
/// Use [`impl_decode_for_turbo_bincode_decode`] to automatically implement the `Encode` trait from
/// this one.
